...
export default function CarCard({ car, isFavorite, onToggleFavorite, onViewDetails }) {
  return (
    <div className="relative bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 border border-gray-200 hover:shadow-blue-400 hover:scale-[1.03]">
      {/* Favorite Button */}
      <button
