...
import ReactShield from "./Components/ReactShild/ReactShild";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // 🔐 Protected Routes
      { path: "favorite", element: <ReactShield><Fav /></ReactShield> },
      { path: "Profile", element: <ReactShield><Profile /></ReactShield> },
      { path: "Selling", element: <ReactShield><Selling /></ReactShield> },
